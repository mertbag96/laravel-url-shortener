...
@section('content')
    ...
    <div class="p-8 bg-white border border-dark/20 rounded-lg shadow-sm text-dark/90 text-sm">
        <h1 class="font-medium text-2xl text-primary mb-4">Privacy Policy</h1>
        ...
        <h2 class="font-medium text-lg text-primary mb-2">1. Information We Collect</h2>
        <p class="mb-2">
        ...
        <h2 class="font-medium text-lg text-primary mb-2">2. How We Use Information</h2>
        <p class="mb-2">
        ...
        <h2 class="font-medium text-lg text-primary mb-2">3. Cookies</h2>
        <p class="mb-2">
        ...
        <h2 class="font-medium text-lg text-primary mb-2">4. Data Storage and Security</h2>
        <p class="mb-2">
        ...
        <h2 class="font-medium text-lg text-primary mb-2">5. Data Retention</h2>
        <p class="mb-2">
            Shortened URLs and related data may be deleted at any time without notice.
            We do not guarantee long-term data retention.
        </p>

        <h2 class="font-medium text-lg text-primary mb-2">6. Third-Party Links</h2>
        <p class="mb-2">
        ...
        <h2 class="font-medium text-lg text-primary mb-2">7. Children’s Privacy</h2>
        <p class="mb-2">
            This service is not intended for use by children under the age of 13.
            We do not knowingly collect personal information from children.
        </p>

        <h2 class="font-medium text-lg text-primary mb-2">8. Changes to This Privacy Policy</h2>
        <p class="mb-2">
            This Privacy Policy may be updated at any time. Changes take effect immediately
            once posted on this page.
        </p>

        <h2 class="font-medium text-lg text-primary mb-2">9. Contact</h2>
        <p class="mb-2">
