...
@section('content')
    ...
    <div class="p-8 bg-white border border-dark/20 rounded-lg shadow-sm text-dark/90 text-sm">
        <h1 class="font-medium text-2xl text-primary mb-4">Terms of Use</h1>
        ...
        <h2 class="font-medium text-lg text-primary mb-2">1. Purpose of the Service</h2>
        <p class="mb-2">
        ...
        <h2 class="font-medium text-lg text-primary mb-2">2. Use of the Service</h2>
        ...
        <h2 class="font-medium text-lg text-primary mb-2">3. Availability and Reliability</h2>
        <p class="mb-2">
        ...
        <h2 class="font-medium text-lg text-primary mb-2">4. Data and Content Responsibility</h2>
        <p class="mb-2">
        ...
        <h2 class="font-medium text-lg text-primary mb-2">5. Limitation of Liability</h2>
        <p class="mb-2">
        ...
        <h2 class="font-medium text-lg text-primary mb-2">6. Intellectual Property</h2>
        <p class="mb-2">
        ...
        <h2 class="font-medium text-lg text-primary mb-2">7. Changes to These Terms</h2>
        <p class="mb-2">
        ...
        <h2 class="font-medium text-lg text-primary mb-2">8. Contact</h2>
        <p class="mb-2">
        ...
        <h2 class="font-medium text-lg text-primary mb-2">Disclaimer</h2>
        <p>
