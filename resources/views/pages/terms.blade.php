...
@section('content')
    <!-- Terms of Use -->
    <div class="bg-white border border-dark/10 rounded-sm shadow-sm py-6 px-8">
        <h1 class="font-semibold text-2xl text-primary mb-4">Terms of Use</h1>
        ...
        <h2 class="font-semibold text-lg text-primary mb-2">2. Use of the Service</h2>
        ...
        <h2 class="font-semibold text-lg text-primary mb-2">3. Availability and Reliability</h2>
        <p class="mb-2">
        ...
        <h2 class="font-semibold text-lg text-primary mb-2">7. Changes to These Terms</h2>
        <p class="mb-2">
        ...
        <h2 class="font-semibold text-lg text-primary mb-2">8. Contact</h2>
        <p class="mb-2">
        ...
        <h2 class="font-semibold text-lg text-primary mb-2">Disclaimer</h2>
        <p>
